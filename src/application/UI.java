...
public class UI { // Interface do usuário
	...
	private static void printPiece(ChessPiece piece, boolean background) { // imprimindo peças
		if(background) {
		...
		System.out.print(" ");
					  ...
					  //imprimindo a lista de peças capturadas
